...
class PaymentGateway(models.Model):
    ...
    webhook_secret = models.CharField(max_length=200, null=True, blank=True, help_text="Webhook secret for signature verification (Razorpay, etc.)")
    gateway_salt = models.CharField(max_length=100, null=True, blank=True, help_text="Salt for PayU, PhonePe, etc.")

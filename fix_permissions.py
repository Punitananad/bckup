...
# Read the file
with open('application/scan2food/adminPortal/views.py', 'r', encoding='utf-8') as f:
    content = f.read()
...
# Write back
with open('application/scan2food/adminPortal/views.py', 'w', encoding='utf-8') as f:
    f.write(new_content)

print("✅ Fixed all permission checks in adminPortal/views.py")
